...
WEBLINKFLAGS=$(WEBFLAGS) -s ALLOW_MEMORY_GROWTH=1 -lwebsocket.js --preload-file assets --use-preload-plugins -s INITIAL_MEMORY=67108864 -s MAXIMUM_MEMORY=1073741824
