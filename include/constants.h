...
const double MAX_SCALE = 15.0;
const int SUBMENU_HORIZONTAL_PADDING = 10;
const int PANEL_TITLE_HEIGHT = 80;
const int PANEL_VERTICAL_PADDING = 0;
const int MAX_TOWERS = 3;
const int TOWER_UPDATE_TIME = 3;
const int MAX_TOWER_HEALTH = 100;
...
const int ZAP_CLEAR_TIME = 4;
const int ZAP_EFFECTS_SUBDIVISION = 30;
